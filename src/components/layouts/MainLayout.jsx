...
function MainLayout({time, children}) {
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="ms-3"><Link to="/attendance">Dashboard</Link></span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap"><Link to="/add-employer">Add Employer</Link></span>
